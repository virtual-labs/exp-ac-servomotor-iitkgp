...
/*  function rotate7(){
 ...
 function rotate9(){
   ...
   document.getElementById('refph').stepUp(1);
...
var myImage = document.getElementById('red_switch');	 
 if(myImage.src.match("./images/red_switch.png")){
	...
	if(document.getElementById('conph').value !=0 && document.getElementById('refph').value !=0){
	...
	document.getElementById("swheel").classList.remove("rotateSwheel");///style["-webkit-animation-duration"] ="0s";
	document.getElementById("bwheel").classList.remove("rotateSwheel");///style["-webkit-animation-duration"] ="0s";
	...
	if((document.getElementById('dc1').value!=0) || (document.getElementById('dcv').value!=0) || (document.getElementById('dcc').value!=0))
	{
...
else if((document.getElementById('dc1').value==0) && (document.getElementById('dcv').value==0) && (document.getElementById('dcc').value==0)){
...
function table1() {//Ec = 220v
    ...
    arr1[2] = math.divide(math.round(math.multiply(document.getElementById("speed").value,100)),100);
...
function table2() {//Ec = 200v
    ...
    arr2[2] = math.divide(math.round(math.multiply(document.getElementById("speed").value,100)),100);
...
function table3() {//Ec = 180v
    ...
    arr3[2] = math.divide(math.round(math.multiply(document.getElementById("speed").value,100)),100);
...
/////////////////////////////////////////////////////////////////////Plot creation Torque vs. Speed////////////////////////////////////////////////////////////////////////// 
	...
	function plot(){
		...
		var ec1 = document.getElementById('Vvalue1').value;
		var ec2 = document.getElementById('Vvalue2').value;
		var ec3 = document.getElementById('Vvalue3').value;
 ...
 function TF(){
	...
	var J = parseFloat(7.64 * Math.pow(10,-4));
	var f = parseFloat(1.45 * Math.pow(10,-4));
	
	var k = $('#kgain').val();
	var f0 = $('#fo').val();
	
	var km = math.divide(k,math.add(f,f0));
	var taum = math.divide(J,math.add(f,f0));
   ...
   if ( document.getElementById('chartContainer').style.display == "block"){	
    document.getElementById('tfn').value= km;//"0.194";	
	document.getElementById('tfd').value= taum;//"0.639";	
 }
 ...
 function Run2() {///step
	...
	//dataPoints.push({x:(t), y:(speed)});
	 ...
	 $('#speed').val(Rspeed);
	   ...
	   if(document.getElementById('Tmassv').value != 0 && document.getElementById('speed').value !=0){
...
if(xlow == 220) {
	 var ylow = 31;///avg speed decrease for 220v	 
}
if (xhigh == 220){
	var yhigh = 31;
}
if(xlow == 240) {
	 var ylow = 31;///avg speed decrease for 240v	 
}
if (xhigh == 240){
	var yhigh = 31;
}
...
function LevelIndicate(){
	...
	var Ea = $('#conph').val();
	 ...
	 var weight = $('#Tmassv').val();
	 var wcoeff = math.divide(weight,10);
	 
	 	
	///Linear interpolation for dcc dcv
...
if(xlow == 140 ){
	 var ylowdc = 0.1;//0.2;///avg dcc dvv value increase for 140v
	 var ylowdv = 0.7;//0.9;
}
if (xhigh == 140){
	var yhighdc = 0.1;
...
if(xlow == 160 ){
	 var ylowdc = 0.1;///avg dcc dvv value increase for 160v
	 var ylowdv = 0.7;
}
if (xhigh == 160){
	var yhighdc = 0.1;
...
if(xlow == 180 ){
	 var ylowdc = 0.1;///avg dcc dvv value increase for 180v
	 var ylowdv = 0.8;//1.0;
}
if (xhigh == 180){
	var yhighdc = 0.1;
...
if(xlow == 200 ){
	 var ylowdc = 0.1;///avg dcc dvv value increase for 200v
	 var ylowdv = 0.7;
}
if (xhigh == 200){
	var yhighdc = 0.1;
...
if(xlow == 220 ){
	 var ylowdc = 0.1;///avg dcc dvv value increase for 220v
	 var ylowdv = 0.7;
}
if (xhigh == 220){
	var yhighdc = 0.1;
...
if(xlow == 240 ){
	 var ylowdc = 0;///avg dcc dvv value increase for 240v
	 var ylowdv = 0;
}
if (xhigh == 240){
	var yhighdc = 0;
	var yhighdv = 0;
	 ...
	 console.log('xlow ='+ xlow);
	 console.log('ylowdc ='+ ylowdc);
	 console.log('ylowdv ='+ ylowdv);
	 
	 console.log('xhigh ='+ xhigh);
	 console.log('yhighdc ='+ yhighdc);
	 console.log('yhighdv ='+ yhighdv);
	 
	 var slopedc = math.divide(math.subtract(yhighdc,ylowdc),math.subtract(xhigh,xlow));
	// console.log('slope = '+ slope);
	 
	 var dcincoeff = math.add(ylowdc,math.multiply(slopedc,math.subtract(Ea,xlow)));	 
	 //console.log('spdrcoeff = '+ spdrcoeff);
	 
	 var slopedv = math.divide(math.subtract(yhighdv,ylowdv),math.subtract(xhigh,xlow));
	// console.log('slope = '+ slope);
	 
	 var dvincoeff = math.add(ylowdv,math.multiply(slopedv,math.subtract(Ea,xlow)));	 
	 //console.log('spdrcoeff = '+ spdrcoeff);
	 
	 var dc = math.divide(math.floor(math.multiply(math.multiply(dcincoeff,wcoeff),10)),10);
	 var dv = math.divide(math.floor(math.multiply(math.multiply(dvincoeff,wcoeff),10)),10);
	 
	 console.log('dc =' + dc);
	 console.log('dv =' + dv);
	
	if(document.getElementById('dcc').value == dc){
	$('#dcv').val(dv);	
	document.getElementById('waterlevel').style.left = '51%';
	}
 }
	...
	// console.log('slope = '+ slope);
	 ...
	 var dc = math.multiply(dcincoeff,wcoeff);
	 var dv = math.multiply(dvincoeff,wcoeff);
